...
def sweep_leverage():
    ...
    for i, l_val in enumerate([100, 400, 800]):
        ...
        sns.lineplot(data=df, x='epoch', y='avg_m_trust', label='Malicious Trust', ax=ax, marker='s')
...
def sweep_reward_rate():
    ...
    plt.figure(figsize=(10, 6))
    sns.lineplot(data=combined_df, x='epoch', y='circulating_supply', hue='rho', marker='o', palette='tab10')
